...
const defaultState = {
  candidates: [
    { id: crypto.randomUUID(), name: "카니쵸니[바카]", cls: "궁성", power: 3219, atool: 55159, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "김규[아리]", cls: "수호성", power: 3583, atool: 115392, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "델[아리]", cls: "정령성", power: 3370, atool: 75788, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "엣피[아리]", cls: "치유성", power: 3149, atool: 35057, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "갱e[바카]", cls: "궁성", power: 3312, atool: 88001, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "까니쵸니[바카]", cls: "호법성", power: 3127, atool: 33705, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "아델[아리]", cls: "살성", power: 3134, atool: 45643, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "겨울마도[바카]", cls: "마도성", power: 3186, atool: 53815, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "탱아저씨[바카]", cls: "수호성", power: 2861, atool: 10869, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "엄마손[바카]", cls: "치유성", power: 2296, atool: 5996, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "마법맨[바카]", cls: "마도성", power: 1584, atool: 648, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "김구[아리]", cls: "검성", power: 2624, atool: 12132, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "은도[아리]", cls: "호법성", power: 2102, atool: 6229, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "히푸[아리]", cls: "치유성", power: 2384, atool: 7107, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "뱐[아리]", cls: "궁성", power: 2350, atool: 7212, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "델이[아리]", cls: "궁성", power: 2396, atool: 6165, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "앳피[아리]", cls: "정령성", power: 2285, atool: 5572, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "겨울살성[바카]", cls: "살성", power: 2725, atool: 9996, updatedAt: 0 },
    { id: crypto.randomUUID(), name: "겨울정령[바카]", cls: "정령성", power: 1435, atool: 4527, updatedAt: 0 },
  ],
