...
const defaultState = {
  ...
  candidates: [
    { id: crypto.randomUUID(), operator: "강력공격맨", name: "카니쵸니[바카]", cls: "궁성", itemLevel: 3805, power: 400700, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "강력공격맨", name: "까니쵸니[바카]", cls: "호법성", itemLevel: 3586, power: 310900, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "강력공격맨", name: "탱아저씨[바카]", cls: "수호성", itemLevel: 3306, power: 236500, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "강력공격맨", name: "엄마손[바카]", cls: "치유성", itemLevel: 3182, power: 193000, updatedAt: 0 },
    // { id: crypto.randomUUID(), operator: "강력공격맨", name: "마법맨[바카]", cls: "마도성", itemLevel: 2322, power: 110600, updatedAt: 0 },

    { id: crypto.randomUUID(), operator: "Pdoll", name: "김규[아리]", cls: "수호성", itemLevel: 4070, power: 447800, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "Pdoll", name: "김구[아리]", cls: "검성", itemLevel: 3146, power: 227200, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "Pdoll", name: "은도[아리]", cls: "호법성", itemLevel: 2821, power: 158900, updatedAt: 0 },
    // { id: crypto.randomUUID(), operator: "Pdoll", name: "하만[아리]", cls: "궁성", itemLevel: 1961, power: 96380, updatedAt: 0 },

    { id: crypto.randomUUID(), operator: "Adele", name: "엣피[아리]", cls: "치유성", itemLevel: 3937, power: 422900, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "Adele", name: "아델[아리]", cls: "살성", itemLevel: 3578, power: 303900, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "Adele", name: "델이[아리]", cls: "궁성", itemLevel: 2862, power: 153800, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "Adele", name: "앳피[아리]", cls: "정령성", itemLevel: 2832, power: 138000, updatedAt: 0 },
    
    { id: crypto.randomUUID(), operator: "재미니맨", name: "델[아리]", cls: "정령성", itemLevel: 3900, power: 372700, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "재미니맨", name: "히푸[아리]", cls: "치유성", itemLevel: 3327, power: 196800, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "재미니맨", name: "뱐[아리]", cls: "궁성", itemLevel: 3007, power: 171600, updatedAt: 0 },
        
    { id: crypto.randomUUID(), operator: "네오", name: "갱e[바카]", cls: "궁성", itemLevel: 4115, power: 508300, updatedAt: 0 },
    { id: crypto.randomUUID(), operator: "네오", name: "겨울마도[바카]", cls: "마도성", itemLevel: 3630, power: 349300, updatedAt: 0 },
