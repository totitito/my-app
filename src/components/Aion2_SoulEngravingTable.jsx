...
export default function SoulEngravingTable() {
  ...
  const rows = [
    ...
    },
    {
      tier: "S",
      cells: {
        w: [{ t: "무피증", c: "red" }, { t: "위력", c: "red" }, { t: "정확" }, {t: "피증"}],
        h: [{ t: "강타", c: "red" }, { t: "받는 치유량", c: "blue" }, { t: "주요 패시브" }],
        s: [{ t: "주요 패시브" }],
        c: [{ t: "주요 패시브" }],
        p: [{ t: "완벽", c: "red" }, { t: "피해 내성", c: "blue" }, { t: "주요 패시브" }],
        g: [{t: "완벽", c: "red"}, { t: "주요 패시브" }],
        m: [{ t: "강타", c: "red" }, {t: "완벽", c: "red"}, { t: "치명타 피해 내성", c: "blue" }, { t: "주요 패시브" }],
        sh: [{t: "완벽", c: "red"}, { t: "주요 패시브" }],
        n: [{ t: "주요 패시브" }],
      },
    },
    {
    ...
    },
    {
      ...
      cells: {
        h: [{ t: "철벽", c: "blue" }],
        s: [{ t: "방어력 증가", c: "blue" }, { t: "철벽", c: "blue" }],
        c: [{ t: "방어력 증가", c: "blue"}, { t: "철벽", c: "blue" }],
        p: [{ t: "철벽", c: "blue" }],
        g: [{ t: "방어력 증가", c: "blue" }, { t: "철벽", c: "blue" }],
        m: [{ t: "무피내", c: "blue" }],
        sh: [{ t: "방어력 증가", c: "blue" }],
      },
    },
